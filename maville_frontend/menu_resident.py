...
class Menu_Resident(Menu):
    def __init__(self,user:Personne) -> None:
        super().__init__()
        self.options = ["Acceuil","Consulter Entraves", "Consulter Travaux", "Consulter travaux à venir", "Consulter travaux residentiels", "Soumettre requete travail","Consulter Profile","Définir ses horraires", "Se deconnecter"]    
        self.user = user
